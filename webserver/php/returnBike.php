...
<html lang="en">
    <head>
        <?php headerText(); ?>
        <title>BikeShare | Return Bike</title>
    </head>
                     ...
                     <div class="col-xs-12 whiteBackground bordered">
                            ...
                            <div class="row hover bordered">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <p>Bike <?php echo $_GET['bikeid']; ?> is to be returned at Bike Station <?php echo $_GET['rackid'] ?>. <br>Back to <a href="getABike.php"> GetABike</a></p>
